      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        <button
          ...
          onClick={() => confirmation.confirm({
            title: "Cancelar reposição programada?",
            confirmMessage: `Você deixará de receber lembretes para ${sub.product.name}. Pedidos já criados permanecem inalterados.`,
            confirmLabel: "Cancelar reposição",
            destructive: true,
            action: () => cancelSubscription(sub.id),

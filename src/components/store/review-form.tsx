...
export function ReviewForm({
  ...
  return (
    ...
    >
      ...
      {state?.ok && (
        <div role="status" aria-live="polite" className="flex items-center gap-2 rounded-xl bg-success-500/10 px-4 py-2.5 text-sm font-medium text-success-600">
        ...
        {[1, 2, 3, 4, 5].map((n) => (
          <span key={n}>
            ...
            <label
              ...
              className="block cursor-pointer rounded p-0.5 peer-focus-visible:outline-none peer-focus-visible:ring-2 peer-focus-visible:ring-brand-500/40"
            >
              <Star
                className={cn(

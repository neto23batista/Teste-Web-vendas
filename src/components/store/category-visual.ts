...
export const categoryColorMap: Record<string, string> = {
  ...
  saude: "bg-sky-100 text-sky-600 dark:bg-sky-500/15 dark:text-sky-300",
  ...
  equipamentos: "bg-indigo-100 text-indigo-600 dark:bg-indigo-500/15 dark:text-indigo-300",
};

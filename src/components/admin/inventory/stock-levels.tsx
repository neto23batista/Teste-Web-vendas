...
import { setStockLevels } from "@/client/api/admin";
...
export function StockLevels({
  ...
  function save() {
    ...
    void run({
      action: () => setStockLevels(inventoryId, minVal, maxVal),
      successMessage: "Níveis atualizados.",
    });
  }

  const box =
    "h-11 w-16 rounded-lg border border-border bg-card px-2 text-center text-sm font-semibold tabular-nums outline-none focus-visible:ring-2 focus-visible:ring-brand-500";
